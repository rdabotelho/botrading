...
public class HighCoinsStrategy implements IStrategy {

    private final static Logger LOG = Logger.getLogger(HighCoinsStrategy.class.getSimpleName());
    
	private static final String NAME = "HIGH COINS";
