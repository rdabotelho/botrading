...
public abstract class ExchangeService implements IExchangeService {
	...
	protected abstract String buy(IOrder IOrder, IExchangeSession session) throws ExchangeException;
	protected abstract String sell(IOrder IOrder, IExchangeSession session) throws ExchangeException;
	protected abstract String immediateSell(IOrder IOrder, IExchangeSession session) throws ExchangeException;
	protected abstract void cancel(IOrder IOrder, IExchangeSession session) throws ExchangeException;	
